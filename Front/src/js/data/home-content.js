...
export const HERO_SLIDES = Object.freeze([
  ...
  },
  {
    ...
    label: 'استایل دونفره',
    title: 'بافت و کژوال، هم‌قدم تا انتهای خیابان',
    subtitle: 'ست‌های بافت و جین در تُن‌های گرم؛ انتخابی راحت برای روزهای کنار هم.',
    cta: { label: 'دیدن کالکشن کژوال', href: 'pages/shop.html' },
    align: 'start',
    tone: {
      text: '#4a3a2a',
